...
/***/ function(module, exports, __webpack_require__) {
	...
	state = (0, _reducers2.default)(state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.suggestions = exports.fetching = exports.errors = exports.allSkiDays = exports.skiDay = exports.goal = undefined;
	    ...
	    switch (action.type) {
	        case _constants2.default.ADD_DAY:
	            ...
	            /*
	                ...
	                dupliates
	             */
	            var hasDay = state.some(function (skiDay) {
	                return skiDay.date === action.payload.date;
	            });

	            return hasDay ? state : [].concat(_toConsumableArray(state), [skiDay(null, action)]).sort(function (a, b) {
	...
	var errors = exports.errors = function errors() {
	    ...
	    switch (action.type) {
	        ...
	        case _constants2.default.CLEAR_ERROR:
	            ...
	            */
	            return state.filter(function (errorMsg, i) {
